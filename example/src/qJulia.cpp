...
void qJulia::render()
{
    ...
    glUniform3fv(_Resolution, 1,
        value_ptr(vec3(theApp->GetWidth(), theApp->GetHeight(),
    ...
    glUniformMatrix3fv(
        _matOrientation, 1, GL_FALSE, value_ptr(transpose(matOrientation)));
