...
#define USE_PROGRAM useProgram();
    ...
    void setUniform2i(GLuint loc, GLint v0, GLint v1)
    {
        glUniform2i(loc, v0, v1);
    }
    void setUniform3i(GLuint loc, GLint v0, GLint v1, GLint v2)
    {
    ...
    void setUniform2ui(GLuint loc, GLuint v0, GLuint v1)
    {
        glUniform2ui(loc, v0, v1);
    }
    void setUniform3ui(GLuint loc, GLuint v0, GLuint v1, GLuint v2)
    {
        glUniform3ui(loc, v0, v1, v2);
    }
    void setUniform4ui(GLuint loc, GLuint v0, GLuint v1, GLuint v2, GLuint v3)
    {
        glUniform4ui(loc, v0, v1, v2, v3);
    }

    // Arrays
    void setUniform1fv(GLuint loc, GLsizei count, const GLfloat* v)
    {
        glUniform1fv(loc, count, v);
    }
    void setUniform2fv(GLuint loc, GLsizei count, const GLfloat* v)
    {
        glUniform2fv(loc, count, v);
    }
    void setUniform3fv(GLuint loc, GLsizei count, const GLfloat* v)
    {
        glUniform3fv(loc, count, v);
    }
    void setUniform4fv(GLuint loc, GLsizei count, const GLfloat* v)
    {
    ...
    void setUniform2iv(GLuint loc, GLsizei count, const GLint* v)
    {
        glUniform2iv(loc, count, v);
    }
    void setUniform3iv(GLuint loc, GLsizei count, const GLint* v)
    {
        glUniform3iv(loc, count, v);
    }
    void setUniform4iv(GLuint loc, GLsizei count, const GLint* v)
    {
        glUniform4iv(loc, count, v);
    }

    void setUniform1uiv(GLuint loc, GLsizei count, const GLuint* v)
    {
        glUniform1uiv(loc, count, v);
    }
    void setUniform2uiv(GLuint loc, GLsizei count, const GLuint* v)
    {
        glUniform2uiv(loc, count, v);
    }
    void setUniform3uiv(GLuint loc, GLsizei count, const GLuint* v)
    {
        glUniform3uiv(loc, count, v);
    }
    void setUniform4uiv(GLuint loc, GLsizei count, const GLuint* v)
    {
        glUniform4uiv(loc, count, v);
    }

    // Matrix
    void setUniformMatrix2fv(GLuint loc,
                             GLsizei count,
                             GLboolean transpose,
                             GLfloat* v)
    {
    ...
    void setUniformMatrix3fv(GLuint loc,
                             GLsizei count,
                             GLboolean transpose,
                             GLfloat* v)
    {
    ...
    void setUniformMatrix4fv(GLuint loc,
                             GLsizei count,
                             GLboolean transpose,
                             GLfloat* v)
    {
...
#else
#define USE_PROGRAM
    void setUniform1f(GLuint loc, GLfloat v0)
    {
    ...
    void setUniform1i(GLuint loc, GLint v0)
    {
    ...
    void setUniform1ui(GLuint loc, GLuint v0)
    {
    ...
    void setVertexAttrib4f(GLuint index,
                           GLfloat v0,
                           GLfloat v1,
                           GLfloat v2,
                           GLfloat v3)
    ...
    // GLdouble
    void setVertexAttrib1d(GLuint index, GLdouble v0)
    {
        glVertexAttrib1d(index, v0);
    }
    void setVertexAttrib2d(GLuint index, GLdouble v0, GLdouble v1)
    {
        glVertexAttrib2d(index, v0, v1);
    }
    void setVertexAttrib3d(GLuint index, GLdouble v0, GLdouble v1, GLdouble v2)
    {
        glVertexAttrib3d(index, v0, v1, v2);
    }
    void setVertexAttrib4d(GLuint index,
                           GLdouble v0,
                           GLdouble v1,
                           GLdouble v2,
                           GLdouble v3)
    ...
    // GLshort
    void setVertexAttrib1s(GLuint index, GLshort v0)
    {
        glVertexAttrib1s(index, v0);
    }
    void setVertexAttrib2s(GLuint index, GLshort v0, GLshort v1)
    {
        glVertexAttrib2s(index, v0, v1);
    }
    void setVertexAttrib3s(GLuint index, GLshort v0, GLshort v1, GLshort v2)
    {
        glVertexAttrib3s(index, v0, v1, v2);
    }
    void setVertexAttrib4s(GLuint index,
                           GLshort v0,
                           GLshort v1,
                           GLshort v2,
                           GLshort v3)
    ...
    // Normalized Byte
    void setVertexAttribNormalizedByte(GLuint index,
                                       GLbyte v0,
                                       GLbyte v1,
                                       GLbyte v2,
                                       GLbyte v3)
    ...
    void setVertexAttrib1i(GLuint index, GLint v0)
    {
        glVertexAttribI1i(index, v0);
    }
    void setVertexAttrib2i(GLuint index, GLint v0, GLint v1)
    {
        glVertexAttribI2i(index, v0, v1);
    }
    void setVertexAttrib3i(GLuint index, GLint v0, GLint v1, GLint v2)
    {
        glVertexAttribI3i(index, v0, v1, v2);
    }
    void setVertexAttrib4i(GLuint index, GLint v0, GLint v1, GLint v2, GLint v3)
    {
        glVertexAttribI4i(index, v0, v1, v2, v3);
    }

    // GLuint (Requires GL_EXT_gpu_shader4)
    void setVertexAttrib1ui(GLuint index, GLuint v0)
    {
        glVertexAttribI1ui(index, v0);
    }
    void setVertexAttrib2ui(GLuint index, GLuint v0, GLuint v1)
    {
        glVertexAttribI2ui(index, v0, v1);
    }
    void setVertexAttrib3ui(GLuint index, GLuint v0, GLuint v1, GLuint v2)
    {
        glVertexAttribI3ui(index, v0, v1, v2);
    }
    void setVertexAttrib4ui(GLuint index,
                            GLuint v0,
                            GLuint v1,
                            GLuint v2,
                            GLuint v3)
...
class mainProgramObj : public ProgramObject
{
  public:
    ...
    virtual ~mainProgramObj()
    {
        removeAllShaders(false);
        deleteAllShaders();
    }

    void useVertex(VertexShader* VS)
    {
        vertObj = VS;
        vsCloned = true;
    }
    ...
    void removeVertex(bool wantDelete = false)
    {
        removeShader(vertObj, vsCloned ? false : wantDelete);
    }
    void removeFragment(bool wantDelete = false)
    {
        removeShader(fragObj, wantDelete);
    }
    void removeAllShaders(bool wantDelete = false)
    {
        removeVertex(wantDelete);
        removeFragment(wantDelete);
        removeGeometry(wantDelete);
    }

    void deleteVertex()
    {
        if (!vsCloned) {
            deleteShader(vertObj);
            delete vertObj;
            vertObj = nullptr;
        }
    }
    ...
    {
        removeShader(geomObj, wantDelete);
    }
    void deleteGeometry()
    {
        deleteShader(geomObj);
        delete geomObj;
        geomObj = nullptr;
    }
...
class uniformBlocksClass
{
  public:
    ...
    void create(GLuint size,
                void* pData,
                GLuint prog,
                const char* nameUBlock,
                GLuint idx = GLuint(bind::bindIdx))
#endif
    {
        bindingLocation = idx;
        realDataSize = size;
        ...
        glNamedBufferStorage(
          uBuffer, uBlockSize, nullptr, GL_DYNAMIC_STORAGE_BIT);
        if (ptrData)
        ...
        glGetActiveUniformBlockiv(
          prog, blockIndex, GL_UNIFORM_BLOCK_DATA_SIZE, &minBlockSize);
    ...
    void updateBufferData(void* data = nullptr)
    {
        ...
        glBindBuffer(GL_UNIFORM_BUFFER, uBuffer);
        glBufferSubData(
          GL_UNIFORM_BUFFER, 0, realDataSize, data ? data : ptrData);
#endif
    ...
    {
        bindIdx = 2
    }; // internal binding indel location
  private:
    void* ptrData;
